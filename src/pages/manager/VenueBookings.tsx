...
import { Building2, Calendar, Clock, TrendingUp, Users, Mail, Star } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gradient-to-br from-primary-50 via-secondary-50 to-accent-50 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="animate-pulse space-y-6">
            {[1, 2, 3].map(i => (
              <div key={i} className="bg-white/80 backdrop-blur-lg p-6 rounded-3xl shadow-soft">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-secondary-50 to-accent-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-neutral-800">Venue Bookings</h1>
        ...
        {venues.length === 0 ? (
          <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-soft border border-white/20 p-12 text-center">
            ...
            <p className="text-neutral-600">Create a venue to start receiving bookings</p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-soft border border-white/20 p-12 text-center">
            ...
            <p className="text-neutral-600">Your venues haven't received any bookings yet</p>
          </div>
        ) : (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-primary-500 to-primary-600 p-6 rounded-3xl shadow-soft text-white">
                ...
                <div className="text-white/90 font-medium">Upcoming Bookings</div>
              </div>
            ...
            <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-soft border border-white/20">
              <div className="p-6 border-b border-white/20">
                <h2 className="text-xl font-semibold text-neutral-800">All Bookings</h2>
              </div>
              ...
              <div className="divide-y divide-white/20">
                {sortedBookings.map((booking) => {
                  ...
                  return (
                    <div key={booking.id} className="p-6 hover:bg-white/40 transition-colors duration-200">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-3">
                            ...
                            <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${bookingStatus.color}`}>
                              {bookingStatus.label}
                            </span>
                          </div>
